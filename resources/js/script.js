...
// If there is anu text inside the item, add that text to the todo list
...
function completeItem() {
  ...
  // Check if the item should be added to the completed task or to re-added to the todo list
  const target =
    parentId === "todo"
...
function addItemToDOM(text, completed) {
  ...
  // Add click event for removing button
  ...
  // Add event for completing items
